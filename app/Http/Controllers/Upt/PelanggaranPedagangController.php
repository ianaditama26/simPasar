...
class PelanggaranPedagangController extends Controller
{
    ...
    public function dtPedagangSp()
    {
        ...
        ->addColumn('action', function($dataPedagang){
            $btn = '<a href="/upt/sp/pedagang/detail/' . $dataPedagang['id'] . '" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Lihat data."><i class="fa fa-eye"></i></a>
            ';
                return $btn;
        })
    ...
    {
        return view('upt.pelanggaran.index');
    }
